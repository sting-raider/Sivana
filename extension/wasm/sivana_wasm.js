...
const WasmFingerprinterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmfingerprinter_free(ptr >>> 0, 1));
/**
*/
export class WasmFingerprinter {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmFingerprinterFinalization.unregister(this);
        return ptr;
    }
    ...
    */
    constructor(sample_rate_hz) {
        const ret = wasm.wasmfingerprinter_new(sample_rate_hz);
        this.__wbg_ptr = ret >>> 0;
        WasmFingerprinterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    */
    finish() {
        try {
            ...
            wasm.wasmfingerprinter_finish(retptr, this.__wbg_ptr);
    ...
    */
    process(pcm) {
        try {
            ...
            wasm.wasmfingerprinter_process(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    */
    version() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmfingerprinter_version(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sivana_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
